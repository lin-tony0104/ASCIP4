...
#tw        
    ...
    def request(self, obj):
        ...
        if obj.o_block in self.history:
            ...
            self.curr_obj.o_cost=curr_reuse_distance*self.curr_obj.o_size+H
        else:
            curr_reuse_distance=self.cache_size
            self.curr_obj.o_cost=curr_reuse_distance*self.curr_obj.o_size+H   #rd設為 cache_size(較大的值)
